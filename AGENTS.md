...
- Se utilizan lenguajes y herramientas nuevas para el desarrollador, como TypeScript, NodeJs, React, PostgresSQL, JWT y se busca que el código sea idiomático, que siga buenas prácticas, y que sea fácil de entender para otros desarrolladores. Debido a esto surge la importancia de comentarios claves con los que estudiar, aprender y entender el código.
